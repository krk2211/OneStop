...
<div id = "home">
    <br />
    <marquee><h3 class="w3-wide">HERE'S ONESTOP THE ONE STOP FOR IT ALL</h3></marquee>
    <b></b>
    <br><br>

    <img src = "../img/aw15r3nt_kbl_lnb_05000f90_gy_3.png" id = "img2">
    <br /><br />
    ...
    $get_stu="select * from item where name='alien'";         //replace name
