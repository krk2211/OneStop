...
<div id = "home">
    ...
    <img src = "../img/razer-blade-14-qhd-touch-i7-6700hq-16gb-ram-512gb-pcie-ssd-nvidia-970m-6gb-windows-10.jpg" id = "img2">
    <br /><br />
    ...
    $get_stu="select * from item where name='razer'";         //replace name
