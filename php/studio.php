...
<div id = "home">
    ...
    <img src = "../img/Beats-1823702445-_0003_overear-studio-wireless-silver-blue-rgb-thrqrtleft-zoom.png" id = "img2">
    <br /><br />
    ...
    $get_stu="select * from item where name='studio'";         //replace name
