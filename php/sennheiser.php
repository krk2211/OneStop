...
<div id = "home">
    ...
    <img src = "../img/square_list_zoom_hd_800_silver_01_sq_sennheiser.png" id = "img2">
    <br /><br />
    ...
    $get_stu="select * from item where name='sennheiser'";         //replace name
