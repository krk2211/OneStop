...
<div id = "home">
    ...
    <img src = "../img/apple-ipad-pro-12.9-space-grey-2up_sku-header.png" id = "img2">
    <br /><br />
    ...
    $get_stu="select * from item where name='samsung'";   		//replace name
